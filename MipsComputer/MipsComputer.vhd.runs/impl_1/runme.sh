...
HD_PWD='C:/Users/nmunozm/MipsComputer.vhd/MipsComputer.vhd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainCtrlUnit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainCtrlUnit.tcl -notrace
