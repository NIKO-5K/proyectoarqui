...
HD_PWD='C:/Users/nmunozm/MipsComputer.vhd/MipsComputer.vhd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainCtrlUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainCtrlUnit.tcl
