...
REM
REM Generated by Vivado on Sat Nov 15 08:47:07 -0500 2025
...
echo "xvhdl --incr --relax -prj MIPSprocesador_vhdl.prj"
call xvhdl  --incr --relax -prj MIPSprocesador_vhdl.prj -log xvhdl.log
